...
export default function SettingsPage() {
    ...
    return (
        <Card className="max-w-xl mx-auto mt-8 border-none shadow-none sm:border sm:shadow-sm">
            <CardHeader>
            ...
            <CardContent className="space-y-8">
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                        <Avatar className="h-28 w-28 border-4 border-white shadow-lg ring-2 ring-zinc-100 dark:ring-zinc-800">
